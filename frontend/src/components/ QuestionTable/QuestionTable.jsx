...
const QuestionTable = () => {
    ...
    const fetchUserStats = async () => {
        try {
            const response = await axios.get(`https://dsa-library.onrender.com/user/grind75-questions/user/stats/${user.id}`);
    ...
    const toggleQuestionCompletion = async (questionId, difficulty) => {
        ...
        try {
            await axios.post('https://dsa-library.onrender.com/user/grind75-questions/user/toggle-completion', {
                userId: user.id,
                questionId,
